...
def _build_times_instruction(roster: CharacterRoster) -> str:
    ...
    return "\n".join(
        (
            ...
            "新しい話題を含む人間の投稿には、原則として3〜8件の短い投稿を返してください。",
            "話題の提示、別の視点からの反応、ツッコミや補足、余韻の順に小さな流れを作ってください。"
            "通常は2〜5人を選び、全員を無理に登場させないでください。",
            "各投稿は1〜3文にし、直前の発言を受けて次の発言につながる具体的なフックを残してください。",
            "1エピソードの投稿数は多くても12件までに抑えてください。",
            "postsを空配列 [] にするのは、currentが新しい話題を含まない短い相槌・定型コマンド・重複通知の場合、"
