...
自律的なメイド集団への発展案は、
[要求分析とユースケース設計](docs/plan/maid_collective_design.md)にまとめています。
[実行設計](docs/architecture/maid_collective_runtime.md)では、責務・データ・
状態遷移・記憶・作業環境・配信と復旧を具体化しています。
実装の起動方法と復旧操作は[メイド集団の運用](docs/collective.md)を参照してください。
